...
//        clientSocket.setSoTimeout(120000);
    ...
    public synchronized boolean isUsernameBusy(String clientUsername) { //Перебирает всех подключившихся пользователей, и если его имя = имени приходящей переменной, то назначить ответ для этого юзера = тру
